<template>
  <div>
    ...
    <div class="challengeContainer">
      ...
      <h2 class="text-xs-center hidden-md-and-down desktopH1 mt-2">Rediger Trin 2</h2>
      ...
      <h2 class="text-xs-center hidden-lg-and-up smallH1 mt-3 mb-2">Rediger Trin 2</h2>
    </div>
