<template>
  <div>
    ...
    <div class="challengeContainer">
      ...
      <h2 class="text-xs-center hidden-md-and-down desktopH1 mt-2">Rediger Forventninger</h2>
      ...
      <!-- header with Rediger Forventninger -->
      <h2 class="text-xs-center hidden-lg-and-up smallH1 mt-3 mb-2">Rediger Forventninger</h2>
    </div>
    ...
    <v-layout align-center justify-center row fill-heigh>
      <v-flex xs12 md7>
        <v-form input>
          ...
          <!-- Question -->
          <h4 class="mb-2 mt-3">Hvor nervøs er du for at udføre denne udfordring?</h4>
          ...
          <!-- Question -->
          <h4 class="mb-2 mt-3">Hvor svær tror du denne udfordring bliver?</h4>
          <!-- 5 radiobuttons one can be pushed -->
          <v-layout>
            <v-flex xs6 md2>Lidt</v-flex>
          ...
          <!-- Header with person -->
          <h4 class="mb-2 mt-3">Skriv de personer der kan hjælpe dig:</h4>
          ...
          <div class="btnContainer">
            <v-btn
              ...
              :to="{name: 'EditNameAndDescrip', params:{user_id: this.$route.params.user_id, udfordringen_id: this.$route.params.udfordringen_id}}"
              ripple
            >Næste</v-btn>
          </div>
        </v-form>
